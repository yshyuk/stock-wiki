...
여기서 [1-1. 주식이란 무엇인가](../part1-basics/1-1-what-is-stock.md)에서 본 구분이 다시 나와요. **회사가 주식을 새로 발행해 팔 때만 그 돈이 회사로 들어가고, 우리가 앱에서 사고파는 건 이미 나와 있는 주식을 다른 투자자에게서 넘겨받는 것**이라고 했죠. 이 둘에 이름을 붙이면 앞쪽이 **발행시장**, 뒤쪽이 **유통시장**이에요. ETF도 똑같아요.
