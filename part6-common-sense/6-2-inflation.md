...
그런데 이자에는 세금이 붙어요. [1-5](../part1-basics/1-5-fees-and-taxes.md)에서 배당에 **15.4%**(소득세 14% + 지방소득세 1.4%)가 **원천징수**된다고 했죠. 원천징수는 **내가 따로 신고하지 않아도 돈을 주는 쪽이 세금을 미리 떼고 나머지만 주는 방식**이에요. **이자소득도 같은 세율로 원천징수돼요.**
